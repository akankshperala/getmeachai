...
const Login = () => {
    ...
    return (
        <div className='text-white py-14 container text-center'>
            <h1 className='font-bold text-3xl'>Login to Get your fans to support you</h1>
            <div className="social-login-button">
                <div className="flex flex-col gap-2 p-10 items-center">
                    ...
                    <button onClick={()=>router.push("/signup")}
                        className="flex items-center w-80 bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <span>Continue via login form</span>
                    </button>
